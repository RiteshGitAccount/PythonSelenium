...
class BaseClass:
    ...
    def drag_and_drop(self, source_locator, target_locator, source_locator_type="xpath", target_locator_type="xpath"):
        ...
        :param source_locator_type:
        :param target_locator_type:
        :return:
        """
        source_element = None
        target_element = None
        ...
        try:
            ...
            self.print_log(
                f"Cannot drag element from locator: {source_locator} - locator_type: {source_locator_type} to target ocator: {target_locator} - locator_type: {target_locator_type}")
            print_stack()
            assert source_element is not None
    ...
    def select_dropdown_by_index(self, data, locator, locator_type="xpath"):
        element = None
        try:
            if locator:
                element = self.get_element(locator, locator_type)
            ...
            self.print_log(f"Cannot select drop down by index for locator: {locator} - locator_type: {locator_type}")
            print_stack()
            assert element is not None

    def select_dropdown_by_value(self, data, locator, locator_type="xpath"):
        element = None
        try:
            if locator:
                element = self.get_element(locator, locator_type)
            ...
            self.print_log(f"Cannot select drop down values based on value for locator: {locator} - locator_type: {locator_type}")
            print_stack()
            assert element is not None

    def select_dropdown_by_visible_text(self, data, locator, locator_type="xpath"):
        element = None
        try:
            if locator:
                element = self.get_element(locator, locator_type)
    ...
    def deselect_dropdown_by_index(self, data, locator, locator_type="xpath"):
        element = None
        try:
            if locator:
                element = self.get_element(locator, locator_type)
            ...
            self.print_log(f"Cannot de-select drop down values based on index for locator: {locator} - locator_type: {locator_type}")
            print_stack()
            assert element is not None

    def deselect_dropdown_by_visible_text(self,  data, locator, locator_type="xpath"):
        element = None
        try:
            if locator:
                element = self.get_element(locator, locator_type)
            ...
            self.print_log(f"Cannot de-select drop down values based on visible text for locator: {locator} - locator_type: {locator_type}")
            print_stack()
            assert element is not None

    def deselect_dropdown_by_value(self,  data, locator, locator_type="xpath"):
        element = None
        try:
            if locator:
                element = self.get_element(locator, locator_type)
